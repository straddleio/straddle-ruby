  ...
  module Models
    module Embed
      class LinkedBankAccountPagedV1 < Straddle::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Straddle::Models::Embed::LinkedBankAccountPagedV1::ResponseType]
        required :response_type, enum: -> { Straddle::Embed::LinkedBankAccountPagedV1::ResponseType }

        # @!method initialize(data:, meta:, response_type:)
        #   Some parameter documentations has been truncated, see
        #   {Straddle::Models::Embed::LinkedBankAccountPagedV1} for more details.
        #
        #   @param data [Array<Straddle::Models::Embed::LinkedBankAccountPagedV1::Data>]
        #
        ...
        #
        #   @param response_type [Symbol, Straddle::Models::Embed::LinkedBankAccountPagedV1::ResponseType] Indicates the structure of the returned content.
        ...
        class Data < Straddle::Internal::Type::BaseModel
          ...
          #
          #   @return [Straddle::Models::Embed::LinkedBankAccountPagedV1::Data::BankAccount]
          required :bank_account, -> { Straddle::Embed::LinkedBankAccountPagedV1::Data::BankAccount }
          ...
          #
          #   @return [Symbol, Straddle::Models::Embed::LinkedBankAccountPagedV1::Data::Status]
          required :status, enum: -> { Straddle::Embed::LinkedBankAccountPagedV1::Data::Status }

          # @!attribute status_detail
          #
          #   @return [Straddle::Models::Embed::LinkedBankAccountPagedV1::Data::StatusDetail]
          required :status_detail, -> { Straddle::Embed::LinkedBankAccountPagedV1::Data::StatusDetail }
          ...
          #
          #   @param bank_account [Straddle::Models::Embed::LinkedBankAccountPagedV1::Data::BankAccount]
          #
          ...
          # @see Straddle::Models::Embed::LinkedBankAccountPagedV1::Data#bank_account
          ...
          # @see Straddle::Models::Embed::LinkedBankAccountPagedV1::Data#status_detail
          class StatusDetail < Straddle::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Straddle::Models::Embed::LinkedBankAccountPagedV1::Data::StatusDetail} for more
            #   details.
            #
            ...
            #
            #   @param reason [Symbol, Straddle::Models::Embed::LinkedBankAccountPagedV1::Data::StatusDetail::Reason] A machine-readable identifier for the specific status, useful for programmatic h
            #
            #   @param source [Symbol, Straddle::Models::Embed::LinkedBankAccountPagedV1::Data::StatusDetail::Source] Identifies the origin of the status change (e.g., `watchtower`). This helps in t

            # A machine-readable identifier for the specific status, useful for programmatic
            # handling.
            #
            # @see Straddle::Models::Embed::LinkedBankAccountPagedV1::Data::StatusDetail#reason
            module Reason
              extend Straddle::Internal::Type::Enum
            ...
            # tracking the cause of status updates.
            #
            # @see Straddle::Models::Embed::LinkedBankAccountPagedV1::Data::StatusDetail#source
            module Source
              extend Straddle::Internal::Type::Enum
        ...
        # - "none" means no data is returned.
        #
        # @see Straddle::Models::Embed::LinkedBankAccountPagedV1#response_type
        module ResponseType
          extend Straddle::Internal::Type::Enum
