  ...
  module Models
    module Embed
      ...
      class Representative < Straddle::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Straddle::Models::Embed::Representative::Data]
        required :data, -> { Straddle::Embed::Representative::Data }
        ...
        #
        #   @return [Symbol, Straddle::Models::Embed::Representative::ResponseType]
        required :response_type, enum: -> { Straddle::Embed::Representative::ResponseType }

        # @!method initialize(data:, meta:, response_type:)
        #   Some parameter documentations has been truncated, see
        #   {Straddle::Models::Embed::Representative} for more details.
        #
        #   @param data [Straddle::Models::Embed::Representative::Data]
        #
        #   @param meta [Straddle::Models::ResponseMetadata] Metadata about the API request, including an identifier and timestamp.
        #
        #   @param response_type [Symbol, Straddle::Models::Embed::Representative::ResponseType] Indicates the structure of the returned content.

        # @see Straddle::Models::Embed::Representative#data
        class Data < Straddle::Internal::Type::BaseModel
          ...
          #
          #   @return [Straddle::Models::Embed::Representative::Data::Relationship]
          required :relationship, -> { Straddle::Embed::Representative::Data::Relationship }
          ...
          #
          #   @return [Symbol, Straddle::Models::Embed::Representative::Data::Status]
          required :status, enum: -> { Straddle::Embed::Representative::Data::Status }

          # @!attribute status_detail
          #
          #   @return [Straddle::Models::Embed::Representative::Data::StatusDetail]
          required :status_detail, -> { Straddle::Embed::Representative::Data::StatusDetail }
          ...
          #   @param name [String]
          #
          #   @param relationship [Straddle::Models::Embed::Representative::Data::Relationship]
          #
          #   @param ssn_last4 [String] The last 4 digits of the representative's Social Security Number.
          #
          #   @param status [Symbol, Straddle::Models::Embed::Representative::Data::Status] The current status of the representative.
          #
          #   @param status_detail [Straddle::Models::Embed::Representative::Data::StatusDetail]
          #
          ...
          # @see Straddle::Models::Embed::Representative::Data#relationship
          class Relationship < Straddle::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Straddle::Models::Embed::Representative::Data::Relationship} for more details.
            #
          ...
          # The current status of the representative.
          #
          # @see Straddle::Models::Embed::Representative::Data#status
          module Status
          ...
          # @see Straddle::Models::Embed::Representative::Data#status_detail
          class StatusDetail < Straddle::Internal::Type::BaseModel
            ...
            #   handling.
            #
            #   @return [Symbol, Straddle::Models::Embed::Representative::Data::StatusDetail::Reason]
            required :reason, enum: -> { Straddle::Embed::Representative::Data::StatusDetail::Reason }

            # @!attribute source
            #   Identifies the origin of the status change (e.g., `watchtower`). This helps in
            #   tracking the cause of status updates.
            #
            #   @return [Symbol, Straddle::Models::Embed::Representative::Data::StatusDetail::Source]
            required :source, enum: -> { Straddle::Embed::Representative::Data::StatusDetail::Source }

            # @!method initialize(code:, message:, reason:, source:)
            #   Some parameter documentations has been truncated, see
            #   {Straddle::Models::Embed::Representative::Data::StatusDetail} for more details.
            #
            ...
            #
            #   @param reason [Symbol, Straddle::Models::Embed::Representative::Data::StatusDetail::Reason] A machine-readable identifier for the specific status, useful for programmatic h
            #
            #   @param source [Symbol, Straddle::Models::Embed::Representative::Data::StatusDetail::Source] Identifies the origin of the status change (e.g., `watchtower`). This helps in t

            # A machine-readable identifier for the specific status, useful for programmatic
            # handling.
            #
            # @see Straddle::Models::Embed::Representative::Data::StatusDetail#reason
            module Reason
              extend Straddle::Internal::Type::Enum
            ...
            # tracking the cause of status updates.
            #
            # @see Straddle::Models::Embed::Representative::Data::StatusDetail#source
            module Source
              extend Straddle::Internal::Type::Enum
        ...
        # - "none" means no data is returned.
        #
        # @see Straddle::Models::Embed::Representative#response_type
        module ResponseType
          extend Straddle::Internal::Type::Enum
