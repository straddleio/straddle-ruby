  ...
  module Models
    module Embed
      class AccountPagedV1 < Straddle::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Straddle::Models::Embed::AccountPagedV1::Data>]
        required :data, -> { Straddle::Internal::Type::ArrayOf[Straddle::Embed::AccountPagedV1::Data] }
        ...
        #
        #   @return [Symbol, Straddle::Models::Embed::AccountPagedV1::ResponseType]
        required :response_type, enum: -> { Straddle::Embed::AccountPagedV1::ResponseType }

        # @!method initialize(data:, meta:, response_type:)
        #   Some parameter documentations has been truncated, see
        #   {Straddle::Models::Embed::AccountPagedV1} for more details.
        #
        #   @param data [Array<Straddle::Models::Embed::AccountPagedV1::Data>]
        #
        ...
        #
        #   @param response_type [Symbol, Straddle::Models::Embed::AccountPagedV1::ResponseType] Indicates the structure of the returned content.
        ...
        class Data < Straddle::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::AccessLevel]
          required :access_level, enum: -> { Straddle::Embed::AccountPagedV1::Data::AccessLevel }
          ...
          #
          #   @return [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::Status]
          required :status, enum: -> { Straddle::Embed::AccountPagedV1::Data::Status }

          # @!attribute status_detail
          #
          #   @return [Straddle::Models::Embed::AccountPagedV1::Data::StatusDetail]
          required :status_detail, -> { Straddle::Embed::AccountPagedV1::Data::StatusDetail }

          # @!attribute type
          #   The type of account (e.g., 'individual', 'business').
          #
          #   @return [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::Type]
          required :type, enum: -> { Straddle::Embed::AccountPagedV1::Data::Type }
          ...
          #
          #   @return [Straddle::Models::Embed::AccountPagedV1::Data::Capabilities, nil]
          optional :capabilities, -> { Straddle::Embed::AccountPagedV1::Data::Capabilities }
          ...
          # @!attribute settings
          #
          #   @return [Straddle::Models::Embed::AccountPagedV1::Data::Settings, nil]
          optional :settings, -> { Straddle::Embed::AccountPagedV1::Data::Settings }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Straddle::Models::Embed::AccountPagedV1::Data} for more details.
          #
          #   @param id [String] Unique identifier for the account.
          #
          #   @param access_level [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::AccessLevel] The access level granted to the account. This is determined by your platform con
          #
          #   @param organization_id [String] The unique identifier of the organization this account belongs to.
          #
          #   @param status [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::Status] The current status of the account (e.g., 'active', 'inactive', 'pending').
          #
          #   @param status_detail [Straddle::Models::Embed::AccountPagedV1::Data::StatusDetail]
          #
          #   @param type [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::Type] The type of account (e.g., 'individual', 'business').
          #
          #   @param business_profile [Straddle::Models::Embed::BusinessProfileV1]
          #
          #   @param capabilities [Straddle::Models::Embed::AccountPagedV1::Data::Capabilities]
          #
          ...
          #
          #   @param settings [Straddle::Models::Embed::AccountPagedV1::Data::Settings]
          #
          ...
          # configuration. Use `standard` unless instructed otherwise by Straddle.
          #
          # @see Straddle::Models::Embed::AccountPagedV1::Data#access_level
          module AccessLevel
          ...
          # The current status of the account (e.g., 'active', 'inactive', 'pending').
          #
          # @see Straddle::Models::Embed::AccountPagedV1::Data#status
          module Status
            extend Straddle::Internal::Type::Enum
          ...
          # @see Straddle::Models::Embed::AccountPagedV1::Data#status_detail
          class StatusDetail < Straddle::Internal::Type::BaseModel
            ...
            #   handling.
            #
            #   @return [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::StatusDetail::Reason]
            required :reason, enum: -> { Straddle::Embed::AccountPagedV1::Data::StatusDetail::Reason }

            # @!attribute source
            #   Identifies the origin of the status change (e.g., `bank_decline`, `watchtower`).
            #   This helps in tracking the cause of status updates.
            #
            #   @return [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::StatusDetail::Source]
            required :source, enum: -> { Straddle::Embed::AccountPagedV1::Data::StatusDetail::Source }

            # @!method initialize(code:, message:, reason:, source:)
            #   Some parameter documentations has been truncated, see
            #   {Straddle::Models::Embed::AccountPagedV1::Data::StatusDetail} for more details.
            #
            ...
            #
            #   @param reason [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::StatusDetail::Reason] A machine-readable identifier for the specific status, useful for programmatic h
            #
            #   @param source [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::StatusDetail::Source] Identifies the origin of the status change (e.g., `bank_decline`, `watchtower`).

            # A machine-readable identifier for the specific status, useful for programmatic
            # handling.
            #
            # @see Straddle::Models::Embed::AccountPagedV1::Data::StatusDetail#reason
            module Reason
              extend Straddle::Internal::Type::Enum
            ...
            # This helps in tracking the cause of status updates.
            #
            # @see Straddle::Models::Embed::AccountPagedV1::Data::StatusDetail#source
            module Source
              extend Straddle::Internal::Type::Enum
          ...
          # The type of account (e.g., 'individual', 'business').
          #
          # @see Straddle::Models::Embed::AccountPagedV1::Data#type
          module Type
            extend Straddle::Internal::Type::Enum
          ...
          # @see Straddle::Models::Embed::AccountPagedV1::Data#capabilities
          class Capabilities < Straddle::Internal::Type::BaseModel
            # @!attribute consent_types
            #
            #   @return [Straddle::Models::Embed::AccountPagedV1::Data::Capabilities::ConsentTypes]
            required :consent_types, -> { Straddle::Embed::AccountPagedV1::Data::Capabilities::ConsentTypes }
            ...
            #
            #   @return [Straddle::Models::Embed::AccountPagedV1::Data::Capabilities::PaymentTypes]
            required :payment_types, -> { Straddle::Embed::AccountPagedV1::Data::Capabilities::PaymentTypes }

            # @!method initialize(consent_types:, customer_types:, payment_types:)
            #   @param consent_types [Straddle::Models::Embed::AccountPagedV1::Data::Capabilities::ConsentTypes]
            #   @param customer_types [Straddle::Models::Embed::AccountPagedV1::Data::Capabilities::CustomerTypes]
            #   @param payment_types [Straddle::Models::Embed::AccountPagedV1::Data::Capabilities::PaymentTypes]

            # @see Straddle::Models::Embed::AccountPagedV1::Data::Capabilities#consent_types
            class ConsentTypes < Straddle::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Straddle::Models::Embed::AccountPagedV1::Data::Capabilities::ConsentTypes} for
              #   more details.
              #
            ...
            # @see Straddle::Models::Embed::AccountPagedV1::Data::Capabilities#customer_types
            ...
            # @see Straddle::Models::Embed::AccountPagedV1::Data::Capabilities#payment_types
          ...
          # @see Straddle::Models::Embed::AccountPagedV1::Data#settings
          class Settings < Straddle::Internal::Type::BaseModel
            # @!attribute charges
            #
            #   @return [Straddle::Models::Embed::AccountPagedV1::Data::Settings::Charges]
            required :charges, -> { Straddle::Embed::AccountPagedV1::Data::Settings::Charges }

            # @!attribute payouts
            #
            #   @return [Straddle::Models::Embed::AccountPagedV1::Data::Settings::Payouts]
            required :payouts, -> { Straddle::Embed::AccountPagedV1::Data::Settings::Payouts }

            # @!method initialize(charges:, payouts:)
            #   @param charges [Straddle::Models::Embed::AccountPagedV1::Data::Settings::Charges]
            #   @param payouts [Straddle::Models::Embed::AccountPagedV1::Data::Settings::Payouts]

            # @see Straddle::Models::Embed::AccountPagedV1::Data::Settings#charges
            class Charges < Straddle::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Straddle::Models::Embed::AccountPagedV1::Data::Settings::Charges} for more
              #   details.
              #
              #   @param daily_amount [Integer] The maximum dollar amount of charges in a calendar day.
              #
              #   @param funding_time [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::Settings::Charges::FundingTime] The amount of time it takes for a charge to be funded. This value is defined by
              #
              ...
              # Straddle.
              #
              # @see Straddle::Models::Embed::AccountPagedV1::Data::Settings::Charges#funding_time
              module FundingTime
                extend Straddle::Internal::Type::Enum
            ...
            # @see Straddle::Models::Embed::AccountPagedV1::Data::Settings#payouts
            class Payouts < Straddle::Internal::Type::BaseModel
              ...
              # @!method initialize(daily_amount:, funding_time:, linked_bank_account_id:, max_amount:, monthly_amount:, monthly_count:)
              #   Some parameter documentations has been truncated, see
              #   {Straddle::Models::Embed::AccountPagedV1::Data::Settings::Payouts} for more
              #   details.
              #
              #   @param daily_amount [Integer] The maximum dollar amount of payouts in a day.
              #
              #   @param funding_time [Symbol, Straddle::Models::Embed::AccountPagedV1::Data::Settings::Payouts::FundingTime] The amount of time it takes for a payout to be funded. This value is defined by
              #
              ...
              # Straddle.
              #
              # @see Straddle::Models::Embed::AccountPagedV1::Data::Settings::Payouts#funding_time
              module FundingTime
                extend Straddle::Internal::Type::Enum
        ...
        # - "none" means no data is returned.
        #
        # @see Straddle::Models::Embed::AccountPagedV1#response_type
        module ResponseType
          extend Straddle::Internal::Type::Enum
