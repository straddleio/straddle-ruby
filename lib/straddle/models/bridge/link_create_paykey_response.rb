  ...
  module Models
    module Bridge
      ...
      class LinkCreatePaykeyResponse < Straddle::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data]
        required :data, -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data }
        ...
        #
        #   @return [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::ResponseType]
        required :response_type, enum: -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::ResponseType }

        # @!method initialize(data:, meta:, response_type:)
        #   Some parameter documentations has been truncated, see
        #   {Straddle::Models::Bridge::LinkCreatePaykeyResponse} for more details.
        #
        #   @param data [Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data]
        #
        #   @param meta [Straddle::Models::ResponseMetadata] Metadata about the API request, including an identifier and timestamp.
        #
        #   @param response_type [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::ResponseType] Indicates the structure of the returned content.

        # @see Straddle::Models::Bridge::LinkCreatePaykeyResponse#data
        class Data < Straddle::Internal::Type::BaseModel
          ...
          # @!attribute config
          #
          #   @return [Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Config]
          required :config, -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Config }
          ...
          # @!attribute source
          #
          #   @return [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Source]
          required :source, enum: -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Source }

          # @!attribute status
          #
          #   @return [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Status]
          required :status, enum: -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Status }
          ...
          # @!attribute balance
          #
          #   @return [Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Balance, nil]
          optional :balance, -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Balance }

          # @!attribute bank_data
          #
          #   @return [Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::BankData, nil]
          optional :bank_data, -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::BankData }
          ...
          #
          #   @param config [Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Config]
          #
          ...
          #
          #   @param source [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Source]
          #
          #   @param status [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Status]
          #
          #   @param updated_at [Time] Timestamp of the most recent update to the paykey.
          #
          #   @param balance [Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Balance]
          #
          #   @param bank_data [Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::BankData]
          #
          ...
          #
          #   @param status_details [Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::StatusDetails]
          ...
          # @see Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data#source
          module Source
            extend Straddle::Internal::Type::Enum
          ...
          # @see Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data#status
          module Status
            extend Straddle::Internal::Type::Enum
          ...
          # @see Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data#balance
          class Balance < Straddle::Internal::Type::BaseModel
            # @!attribute status
            #
            #   @return [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Balance::Status]
            required :status, enum: -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Balance::Status }
            ...
            #   @param status [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Balance::Status]
            #
            ...
            # @see Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::Balance#status
            module Status
              extend Straddle::Internal::Type::Enum
          ...
          # @see Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data#bank_data
          class BankData < Straddle::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::BankData::AccountType]
            required :account_type,
                     enum: -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::BankData::AccountType }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::BankData} for more
            #   details.
            #
            #   @param account_number [String] Bank account number. This value is masked by default for security reasons. Use t
            #
            #   @param account_type [Symbol, Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::BankData::AccountType]
            #
            #   @param routing_number [String] The routing number of the bank account.

            # @see Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::BankData#account_type
            module AccountType
              extend Straddle::Internal::Type::Enum
          ...
          # @see Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data#status_details
          class StatusDetails < Straddle::Internal::Type::BaseModel
            ...
            required :source,
                     enum: -> { Straddle::Models::Bridge::LinkCreatePaykeyResponse::Data::StatusDetails::Source }
        ...
        # - "none" means no data is returned.
        #
        # @see Straddle::Models::Bridge::LinkCreatePaykeyResponse#response_type
        module ResponseType
          extend Straddle::Internal::Type::Enum
