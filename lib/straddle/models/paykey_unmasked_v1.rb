...
module Straddle
  module Models
    # @see Straddle::Resources::Paykeys#unmasked
    class PaykeyUnmaskedV1 < Straddle::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Straddle::Models::PaykeyUnmaskedV1::Data]
      required :data, -> { Straddle::PaykeyUnmaskedV1::Data }
      ...
      #
      #   @return [Symbol, Straddle::Models::PaykeyUnmaskedV1::ResponseType]
      required :response_type, enum: -> { Straddle::PaykeyUnmaskedV1::ResponseType }

      # @!method initialize(data:, meta:, response_type:)
      #   Some parameter documentations has been truncated, see
      #   {Straddle::Models::PaykeyUnmaskedV1} for more details.
      #
      #   @param data [Straddle::Models::PaykeyUnmaskedV1::Data]
      #
      #   @param meta [Straddle::Models::ResponseMetadata] Metadata about the API request, including an identifier and timestamp.
      #
      #   @param response_type [Symbol, Straddle::Models::PaykeyUnmaskedV1::ResponseType] Indicates the structure of the returned content.

      # @see Straddle::Models::PaykeyUnmaskedV1#data
      class Data < Straddle::Internal::Type::BaseModel
        ...
        # @!attribute config
        #
        #   @return [Straddle::Models::PaykeyUnmaskedV1::Data::Config]
        required :config, -> { Straddle::PaykeyUnmaskedV1::Data::Config }
        ...
        # @!attribute source
        #
        #   @return [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::Source]
        required :source, enum: -> { Straddle::PaykeyUnmaskedV1::Data::Source }

        # @!attribute status
        #
        #   @return [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::Status]
        required :status, enum: -> { Straddle::PaykeyUnmaskedV1::Data::Status }
        ...
        # @!attribute balance
        #
        #   @return [Straddle::Models::PaykeyUnmaskedV1::Data::Balance, nil]
        optional :balance, -> { Straddle::PaykeyUnmaskedV1::Data::Balance }

        # @!attribute bank_data
        #
        #   @return [Straddle::Models::PaykeyUnmaskedV1::Data::BankData, nil]
        optional :bank_data, -> { Straddle::PaykeyUnmaskedV1::Data::BankData }
        ...
        #
        #   @param config [Straddle::Models::PaykeyUnmaskedV1::Data::Config]
        #
        ...
        #
        #   @param source [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::Source]
        #
        #   @param status [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::Status]
        #
        #   @param updated_at [Time] Timestamp of the most recent update to the paykey.
        #
        #   @param balance [Straddle::Models::PaykeyUnmaskedV1::Data::Balance]
        #
        #   @param bank_data [Straddle::Models::PaykeyUnmaskedV1::Data::BankData]
        #
        ...
        #
        #   @param status_details [Straddle::Models::PaykeyUnmaskedV1::Data::StatusDetails]
        ...
        # @see Straddle::Models::PaykeyUnmaskedV1::Data#source
        module Source
          extend Straddle::Internal::Type::Enum
        ...
        # @see Straddle::Models::PaykeyUnmaskedV1::Data#status
        module Status
          extend Straddle::Internal::Type::Enum
        ...
        # @see Straddle::Models::PaykeyUnmaskedV1::Data#balance
        class Balance < Straddle::Internal::Type::BaseModel
          # @!attribute status
          #
          #   @return [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::Balance::Status]
          required :status, enum: -> { Straddle::PaykeyUnmaskedV1::Data::Balance::Status }
          ...
          #   @param status [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::Balance::Status]
          #
          ...
          # @see Straddle::Models::PaykeyUnmaskedV1::Data::Balance#status
          module Status
            extend Straddle::Internal::Type::Enum
        ...
        # @see Straddle::Models::PaykeyUnmaskedV1::Data#bank_data
        class BankData < Straddle::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::BankData::AccountType]
          required :account_type, enum: -> { Straddle::PaykeyUnmaskedV1::Data::BankData::AccountType }
          ...
          #
          #   @param account_type [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::BankData::AccountType]
          #
          #   @param routing_number [String] The routing number of the bank account.

          # @see Straddle::Models::PaykeyUnmaskedV1::Data::BankData#account_type
          module AccountType
            extend Straddle::Internal::Type::Enum
        ...
        # @see Straddle::Models::PaykeyUnmaskedV1::Data#status_details
        class StatusDetails < Straddle::Internal::Type::BaseModel
          ...
          #   handling.
          #
          #   @return [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::StatusDetails::Reason]
          required :reason, enum: -> { Straddle::PaykeyUnmaskedV1::Data::StatusDetails::Reason }

          # @!attribute source
          #   Identifies the origin of the status change (e.g., 'bank_decline', 'watchtower').
          #   This helps in tracking the cause of status updates.
          #
          #   @return [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::StatusDetails::Source]
          required :source, enum: -> { Straddle::PaykeyUnmaskedV1::Data::StatusDetails::Source }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Straddle::Models::PaykeyUnmaskedV1::Data::StatusDetails} for more details.
          #
          ...
          #
          #   @param reason [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::StatusDetails::Reason] A machine-readable identifier for the specific status, useful for programmatic h
          #
          #   @param source [Symbol, Straddle::Models::PaykeyUnmaskedV1::Data::StatusDetails::Source] Identifies the origin of the status change (e.g., 'bank_decline', 'watchtower').
          #
          ...
          # handling.
          #
          # @see Straddle::Models::PaykeyUnmaskedV1::Data::StatusDetails#reason
          module Reason
            extend Straddle::Internal::Type::Enum
          ...
          # This helps in tracking the cause of status updates.
          #
          # @see Straddle::Models::PaykeyUnmaskedV1::Data::StatusDetails#source
          module Source
            extend Straddle::Internal::Type::Enum
      ...
      # - "none" means no data is returned.
      #
      # @see Straddle::Models::PaykeyUnmaskedV1#response_type
      module ResponseType
        extend Straddle::Internal::Type::Enum
