    ...
    module Util
      ...
      class << self
        ...
        def encode_content(headers, body)
          ...
          in [Straddle::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [Straddle::Internal::Util::JSONL_CONTENT, Enumerable] unless Straddle::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | Straddle::Internal::Type::FileInput]
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [Straddle::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in Straddle::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
