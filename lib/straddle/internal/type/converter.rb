    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Straddle::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Straddle::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Straddle::FilePart.new(value)
          in Straddle::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Straddle::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Straddle::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Straddle::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Straddle::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Straddle::Internal::Type::Converter
              ...
              Straddle::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Straddle::Internal::Type::Converter, T::Class[T.anything]) }
        end
