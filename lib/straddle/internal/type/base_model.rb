    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param child [Class<Straddle::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            ...
            type_fn, info =
              ...
              in Proc | Straddle::Internal::Type::Converter | Class
                [Straddle::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [Straddle::Internal::Type::Converter.type_info(type_info), type_info]
              end
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = Straddle::Internal::Type::Converter.new_coerce_state(translate_names: false)
              coerced = Straddle::Internal::Type::Converter.coerce(target, value, state: state)
              status = @coerced.store(name_sym, state.fetch(:error) || true)
              stored =
                case [target, status]
                in [Straddle::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if Straddle::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise Straddle::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == Straddle::Internal::OMIT ? nil : const }
                  state = Straddle::Internal::Type::Converter.new_coerce_state(translate_names: false)
                  if (nilable || !required) && value.nil?
                    nil
                  else
                    Straddle::Internal::Type::Converter.coerce(
          ...
          # @return [Boolean]
          def ==(other)
            other.is_a?(Class) && other <= Straddle::Internal::Type::BaseModel && other.fields == fields
          end
        ...
        class << self
          # @api private
          #
          # @param value [Straddle::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
          ...
          def coerce(value, state:)
            ...
            unless (val = Straddle::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              unless val.key?(src_name)
                if required && mode != :dump && const == Straddle::Internal::OMIT
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = Straddle::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in Straddle::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = Straddle::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, Straddle::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            known_fields.each_value do |field|
              ...
              next if mode == :coerce || acc.key?(api_name) || const == Straddle::Internal::OMIT
        ...
        class << self
          # @api private
          #
          # @param model [Straddle::Internal::Type::BaseModel]
        ...
        #
        # @example
        #   # `customer_details_v1` is a `Straddle::CustomerDetailsV1`
        #   customer_details_v1 => {
        #     id: id,
        ...
        #
        # @return [String]
        def to_json(*a) = Straddle::Internal::Type::Converter.dump(self.class, self).to_json(*a)
        ...
        #
        # @return [String]
        def to_yaml(*a) = Straddle::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          Straddle::Internal::Util.coerce_hash!(data).each do
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                Straddle::Internal::Type::Converter.inspect(type, depth: depth),
