  ...
  module Internal
    module Type
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, Straddle::Internal::Type::Converter, Class]
        #
        ...
        # @param value [Object]
        #
        # @return [Straddle::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          case [@discriminator, value]
          in [_, Straddle::Internal::Type::BaseModel]
            value.class
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, Straddle::Internal::OMIT)
            end
        ...
        # @return [Boolean]
        def ==(other)
          Straddle::Internal::Type::Union === other && other.derefed_variants == derefed_variants
        end
        ...
        def coerce(value, state:)
          if (target = resolve_variant(value))
            return Straddle::Internal::Type::Converter.coerce(target, value, state: state)
          end
        ...
        def dump(value, state:)
          if (target = resolve_variant(value))
            return Straddle::Internal::Type::Converter.dump(target, value, state: state)
          end

          known_variants.each do
            target = _2.call
            return Straddle::Internal::Type::Converter.dump(target, value, state: state) if target === value
          end
        ...
        # @return [Object]
        def to_sorbet_type
          types = variants.map { Straddle::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(_1) }.uniq
          case types
          in []
            T.noreturn
          in [type]
        ...
        def inspect(depth: 0)
          ...
          members = variants.map { Straddle::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
