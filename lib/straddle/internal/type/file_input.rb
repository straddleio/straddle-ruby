...
module Straddle
  module Internal
    module Type
      ...
      # `Straddle::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Straddle::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Straddle::Internal::Type::FileInput
        ...
        class << self
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, Straddle::FilePart)
          end
        end
      end
    end
