      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - Straddle::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = Straddle::Internal::Util.uri_origin(url)
          timeout = deadline - Straddle::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise Straddle::Errors::APIConnectionError.new(url: url, request: req)
          end
