  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Straddle::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Straddle::Internal::Util.os,
            "x-stainless-package-version" => Straddle::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Straddle::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Straddle::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Straddle::Internal::Util.uri_origin(url) != Straddle::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, Straddle::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in Straddle::Errors::APIConnectionError | (500..)
              Straddle::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [Straddle::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = Straddle::Internal::Transport::PooledNetRequester.new
          @headers = Straddle::Internal::Util.normalized_headers(
          ...
          @base_url_components = Straddle::Internal::Util.parse_uri(base_url)
          @base_url = Straddle::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        #   @option req [Class<Straddle::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<Straddle::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [Straddle::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = Straddle::Internal::Util.interpolate_path(uninterpolated_path)

          query = Straddle::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = Straddle::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise Straddle::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in (400..) | Straddle::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: Straddle::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param page [Class<Straddle::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<Straddle::Internal::Type::BaseStream>, nil]
        #
        # @param model [Straddle::Internal::Type::Converter, Class, nil]
        #
        # @param options [Straddle::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { Straddle::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          Straddle::RequestOptions.validate!(opts)
          ...
          T.type_alias do
            {
              ...
              page: T.nilable(T::Class[Straddle::Internal::Type::BasePage[Straddle::Internal::Type::BaseModel]]),
              stream: T.nilable(T::Class[T.anything]),
              model: T.nilable(Straddle::Internal::Type::Converter::Input),
              options: T.nilable(Straddle::RequestOptions::OrHash)
            }
          end
        end
