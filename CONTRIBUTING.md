...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/straddle/helpers/` and `examples/` directory.
...
```ruby
gem "straddle", git: "https://www.github.com/straddleio/straddle-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/straddleio/straddle-ruby' '<path-to-repo>'
```

```ruby
gem "straddle", path: "<path-to-repo>"
```
