...
class Straddle::Test::PrimitiveModelTest < Minitest::Test
  A = Straddle::Internal::Type::ArrayOf[-> { Integer }]
  H = Straddle::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Straddle::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Straddle::Internal::Type::Unknown,
      Straddle::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Straddle::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Straddle::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Straddle::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Straddle::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Straddle::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Straddle::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Straddle::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Straddle::Internal::Type::Boolean, true] => true,
      [Straddle::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Straddle::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Straddle::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Straddle::Internal::Type::Converter.new_coerce_state
      Straddle::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Straddle::Internal::Type::Converter.dump(target, input, state: state)
...
class Straddle::Test::EnumModelTest < Minitest::Test
  class E0
    include Straddle::Internal::Type::Enum
    attr_reader :values
...
class Straddle::Test::CollectionModelTest < Minitest::Test
  A1 = Straddle::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Straddle::Internal::Type::HashOf[Integer]

  A2 = Straddle::Internal::Type::ArrayOf[H1]
  H2 = Straddle::Internal::Type::HashOf[-> { A1 }]

  A3 = Straddle::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Straddle::Internal::Type::HashOf[Integer, nil?: true]
...
class Straddle::Test::BaseModelTest < Minitest::Test
  ...
  class M3 < Straddle::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Straddle::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Straddle::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Straddle::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Straddle::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Straddle::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Straddle::Errors::ConversionError => e
...
class Straddle::Test::UnionTest < Minitest::Test
  class U0
    include Straddle::Internal::Type::Union
  ...
  class M2 < Straddle::Internal::Type::BaseModel
  ...
  class M4 < Straddle::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Straddle::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Straddle::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Straddle::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Straddle::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Straddle::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [Straddle::Internal::Type::Unknown, Straddle::Internal::Type::Unknown] => true,
      [Straddle::Internal::Type::Boolean, Straddle::Internal::Type::Boolean] => true,
      [Straddle::Internal::Type::Unknown, Straddle::Internal::Type::Boolean] => false,
