...
class StraddleTest < Minitest::Test
  ...
  def test_raises_on_unknown_environment
    e = assert_raises(ArgumentError) do
      Straddle::Client.new(environment: "wrong")
    end
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/v1/charges").to_return_json(status: 500, body: {})

    straddle = Straddle::Client.new(base_url: "http://localhost", api_key: "My API Key")
  ...
  def test_client_given_request_default_retry_attempts
    ...
    straddle = Straddle::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_redirect_307
    ...
    assert_raises(Straddle::Errors::APIConnectionError) do
      straddle.charges.create(
        amount: 10_000,
        config: {balance_check: :required},
        consent_type: :internet,
    ...
    assert_requested(:any, "http://localhost/redirected", times: Straddle::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Straddle::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Straddle::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/v1/charges").to_return_json(status: 200, body: {})
