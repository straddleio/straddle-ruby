...
class Straddle::Test::SingletonClient < Straddle::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Straddle::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Straddle::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @straddle = Straddle::Test::SingletonClient.instance
  end
