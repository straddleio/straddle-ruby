    ...
    class ChargeUnmaskResponse < Straddle::Internal::Type::BaseModel
      ...
      class Data < Straddle::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Straddle::Models::ChargeUnmaskResponse::Data::Document]
            )
          )
        end
        ...
        sig do
          params(
            ...
            documents:
              T.nilable(
                T::Array[
                  Straddle::Models::ChargeUnmaskResponse::Data::Document::OrHash
                ]
              ),
            ...
            related_payments:
              T.nilable(
                T::Array[
                  Straddle::Models::ChargeUnmaskResponse::Data::RelatedPayment::OrHash
                ]
              )
          ).returns(T.attached_class)
        end
          ...
          override.returns(
            {
              ...
              documents:
                T.nilable(
                  T::Array[
                    Straddle::Models::ChargeUnmaskResponse::Data::Document
                  ]
                ),
              effective_at: T.nilable(Time),
              metadata: T.nilable(T::Hash[Symbol, String]),
        ...
        class Document < Straddle::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Straddle::Models::ChargeUnmaskResponse::Data::Document::DocumentType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              document_type:
                Straddle::Models::ChargeUnmaskResponse::Data::Document::DocumentType::OrSymbol,
              uploaded_at: Time
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          module DocumentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Straddle::Models::ChargeUnmaskResponse::Data::Document::DocumentType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class RelatedPayment < Straddle::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Straddle::Models::ChargeUnmaskResponse::Data::RelatedPayment::PaymentType::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Straddle::Models::ChargeUnmaskResponse::Data::RelatedPayment::Relationship::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              id: String,
              payment_type:
                Straddle::Models::ChargeUnmaskResponse::Data::RelatedPayment::PaymentType::OrSymbol,
              relationship:
                Straddle::Models::ChargeUnmaskResponse::Data::RelatedPayment::Relationship::OrSymbol
            ).returns(T.attached_class)
          end
          def self.new(
            # The ID of the related payment.
          ...
          module PaymentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Straddle::Models::ChargeUnmaskResponse::Data::RelatedPayment::PaymentType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module Relationship
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Straddle::Models::ChargeUnmaskResponse::Data::RelatedPayment::Relationship
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
