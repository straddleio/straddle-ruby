    ...
    module Embed
      class LinkedBankAccountPagedV1 < Straddle::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Straddle::Embed::LinkedBankAccountPagedV1,
              Straddle::Internal::AnyHash
            )
          end

        sig do
          returns(T::Array[Straddle::Embed::LinkedBankAccountPagedV1::Data])
        end
        attr_accessor :data
        ...
        sig do
          returns(
            Straddle::Embed::LinkedBankAccountPagedV1::ResponseType::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            data:
              T::Array[Straddle::Embed::LinkedBankAccountPagedV1::Data::OrHash],
            meta: Straddle::PagedResponseMetadata::OrHash,
            response_type:
              Straddle::Embed::LinkedBankAccountPagedV1::ResponseType::OrSymbol
        ...
        sig do
          override.returns(
            {
              data: T::Array[Straddle::Embed::LinkedBankAccountPagedV1::Data],
        ...
        class Data < Straddle::Internal::Type::BaseModel
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Straddle::Embed::LinkedBankAccountPagedV1::Data::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class StatusDetail < Straddle::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Straddle::Embed::LinkedBankAccountPagedV1::Data::StatusDetail::Reason::TaggedSymbol
              )
            end
            ...
            sig do
              returns(
                Straddle::Embed::LinkedBankAccountPagedV1::Data::StatusDetail::Source::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                ...
                message: String,
                reason:
                  Straddle::Embed::LinkedBankAccountPagedV1::Data::StatusDetail::Reason::OrSymbol,
                source:
                  Straddle::Embed::LinkedBankAccountPagedV1::Data::StatusDetail::Source::OrSymbol
              ).returns(T.attached_class)
            end
            def self.new(
              # A machine-readable code for the specific status, useful for programmatic
        ...
        module ResponseType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Straddle::Embed::LinkedBankAccountPagedV1::ResponseType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
