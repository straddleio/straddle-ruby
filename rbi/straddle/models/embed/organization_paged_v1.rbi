    ...
    module Embed
      class OrganizationPagedV1 < Straddle::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Straddle::Embed::OrganizationPagedV1,
              Straddle::Internal::AnyHash
            )
          end

        sig { returns(T::Array[Straddle::Embed::OrganizationPagedV1::Data]) }
        attr_accessor :data
        ...
        sig do
          returns(
            Straddle::Embed::OrganizationPagedV1::ResponseType::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            data: T::Array[Straddle::Embed::OrganizationPagedV1::Data::OrHash],
            meta: Straddle::PagedResponseMetadata::OrHash,
            response_type:
              Straddle::Embed::OrganizationPagedV1::ResponseType::OrSymbol
        ...
        sig do
          override.returns(
            {
              data: T::Array[Straddle::Embed::OrganizationPagedV1::Data],
        ...
        module ResponseType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Straddle::Embed::OrganizationPagedV1::ResponseType)
            end
