    ...
    module Embed
      class RepresentativePaged < Straddle::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Straddle::Embed::RepresentativePaged,
              Straddle::Internal::AnyHash
            )
          end

        sig { returns(T::Array[Straddle::Embed::RepresentativePaged::Data]) }
        attr_accessor :data
        ...
        sig do
          returns(
            Straddle::Embed::RepresentativePaged::ResponseType::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            data: T::Array[Straddle::Embed::RepresentativePaged::Data::OrHash],
            meta: Straddle::PagedResponseMetadata::OrHash,
            response_type:
              Straddle::Embed::RepresentativePaged::ResponseType::OrSymbol
        ...
        sig do
          override.returns(
            {
              data: T::Array[Straddle::Embed::RepresentativePaged::Data],
        ...
        class Data < Straddle::Internal::Type::BaseModel
          ...
          sig do
            returns(Straddle::Embed::RepresentativePaged::Data::Relationship)
          end
          ...
          sig do
            params(
              relationship:
                Straddle::Embed::RepresentativePaged::Data::Relationship::OrHash
            ).void
          end
          ...
          sig do
            returns(
              Straddle::Embed::RepresentativePaged::Data::Status::TaggedSymbol
            )
          end
          attr_accessor :status

          sig do
            returns(Straddle::Embed::RepresentativePaged::Data::StatusDetail)
          end
          ...
          sig do
            params(
              ...
              ssn_last4: String,
              status:
                Straddle::Embed::RepresentativePaged::Data::Status::OrSymbol,
              status_detail:
                Straddle::Embed::RepresentativePaged::Data::StatusDetail::OrHash,
              updated_at: Time,
            ...
            override.returns(
              {
                ...
                name: String,
                relationship:
                  Straddle::Embed::RepresentativePaged::Data::Relationship,
                ssn_last4: String,
                status:
                  Straddle::Embed::RepresentativePaged::Data::Status::TaggedSymbol,
                status_detail:
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Straddle::Embed::RepresentativePaged::Data::Status
                )
              end
          ...
          class StatusDetail < Straddle::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Straddle::Embed::RepresentativePaged::Data::StatusDetail::Reason::TaggedSymbol
              )
            end
            ...
            sig do
              returns(
                Straddle::Embed::RepresentativePaged::Data::StatusDetail::Source::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                ...
                message: String,
                reason:
                  Straddle::Embed::RepresentativePaged::Data::StatusDetail::Reason::OrSymbol,
                source:
                  Straddle::Embed::RepresentativePaged::Data::StatusDetail::Source::OrSymbol
              ).returns(T.attached_class)
            end
            def self.new(
              # A machine-readable code for the specific status, useful for programmatic
            ...
            module Reason
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Straddle::Embed::RepresentativePaged::Data::StatusDetail::Reason
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module Source
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Straddle::Embed::RepresentativePaged::Data::StatusDetail::Source
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module ResponseType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Straddle::Embed::RepresentativePaged::ResponseType)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
