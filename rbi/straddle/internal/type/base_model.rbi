    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Straddle::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            params(
              ...
              spec: Straddle::Internal::AnyHash
            ).void
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Straddle::Internal::Type::BaseModel,
              convert: T::Boolean
        ...
        sig { overridable.returns(Straddle::Internal::AnyHash) }
        def to_h
        end
