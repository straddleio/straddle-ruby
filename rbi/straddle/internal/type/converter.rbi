  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Straddle::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        sig do
          overridable
            .params(
              value: T.anything,
              state: Straddle::Internal::Type::Converter::CoerceState
            )
            .returns(T.anything)
        end
        ...
        sig do
          overridable
            .params(
              value: T.anything,
              state: Straddle::Internal::Type::Converter::DumpState
            )
            .returns(T.anything)
        end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Straddle::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Straddle::Internal::Type::Converter::Input,
              value: T.anything,
              state: Straddle::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
