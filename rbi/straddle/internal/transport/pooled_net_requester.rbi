      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                Straddle::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: Straddle::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: Straddle::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
