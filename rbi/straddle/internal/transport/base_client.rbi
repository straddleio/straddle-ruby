    ...
    module Transport
      ...
      class BaseClient
          ...
          T.type_alias do
            {
              ...
              page:
                T.nilable(
                  T::Class[
                    Straddle::Internal::Type::BasePage[
        ...
        class << self
          ...
          sig do
            params(
              status: T.any(Integer, Straddle::Errors::APIConnectionError),
        ...
        # @api private
        sig { returns(Straddle::Internal::Transport::PooledNetRequester) }
        ...
        sig do
          overridable
            .params(
              req: Straddle::Internal::Transport::BaseClient::RequestComponents,
              opts: Straddle::Internal::AnyHash
            )
            .returns(Straddle::Internal::Transport::BaseClient::RequestInput)
        end
        ...
        def request(
          ...
          page: nil,
          stream: nil,
          model: Straddle::Internal::Type::Unknown,
          options: {}
        )
        end
